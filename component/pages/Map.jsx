...
export const Map = () => {
  return (
    <section className="bg-gray-200/75 min-h-max py-12 mt-12 flex flex-col items-center dark:bg-black">
      <div className="rounded-xl w-7/12 h-[350px] overflow-hidden border-[6px] border-gray-50/25">
        <iframe
